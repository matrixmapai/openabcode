...
// Regression for https://github.com/matrixmapai/openabcode/issues/<issue-number>
...
describe("openai-completions empty tools handling", () => {
	...
	// Gateway auth resolution (headers + baseUrl placeholders) is covered in
	// providers.test.ts; the gateway catalog no longer carries completions models.
