...
const CONFIG_DIR_NAME = ".openabcode";
const ENV_ORCHESTRATOR_DIR = "OPENABCODE_ORCHESTRATOR_DIR";
...
export function getOrchestratorDir(): string {
	...
	const piDir = process.env.OPENABCODE_CONFIG_DIR || join(homedir(), CONFIG_DIR_NAME);
