...
See [AGENTS.md](https://github.com/matrixmapai/openabcode/blob/main/AGENTS.md) for additional guidelines.
...
`/debug` (hidden) writes to `~/.openabcode/agent/openabcode-debug.log`:
