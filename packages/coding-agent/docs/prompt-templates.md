> openabcode can create prompt templates. Ask it to build one for your workflow.
...
OpenABCode loads prompt templates from:

- Global: `~/.openabcode/agent/prompts/*.md`
- Project: `.openabcode/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `openabcode.prompts` entries in `package.json`
