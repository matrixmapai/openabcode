...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@openabcode/coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@openabcode/coding-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown openabcode and exit. Available in all contexts. */
	shutdown(): void;
...
export type ModelSelectSource = "set" | "cycle" | "restore" | "route";
