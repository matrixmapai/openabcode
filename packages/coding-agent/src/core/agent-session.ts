...
import type {
	...
	ThinkingLevel,
} from "@openabcode/agent-core";
import type { AssistantMessage, ImageContent, Message, Model, TextContent } from "@openabcode/ai/compat";
import {
	clampThinkingLevel,
...
export class AgentSession {
	...
	private async _emitModelSelect(
		...
		source: "set" | "cycle" | "restore" | "route",
	): Promise<void> {
	...
	/** Current OpenABCode routing mode: "auto" routes each prompt, "manual" respects the chosen model. */
	get routeMode(): "auto" | "manual" {
