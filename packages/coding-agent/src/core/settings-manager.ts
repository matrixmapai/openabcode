...
import type { Transport } from "@openabcode/ai";
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.OPENABCODE_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.OPENABCODE_HARDWARE_CURSOR === "1";
	}
