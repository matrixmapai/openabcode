...
import { Agent, type AgentMessage, type ThinkingLevel } from "@openabcode/agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@openabcode/ai/compat";
...
export interface CreateAgentSessionOptions {
	...
	cwd?: string;
	/** Global config directory. Default: ~/.openabcode/agent */
	agentDir?: string;
	 ...
	 *
	 * When omitted, openabcode enables the default built-in tools (read, bash, edit, write)
