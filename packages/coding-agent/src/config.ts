...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/matrixmapai/openabcode/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.OPENABCODE_PACKAGE_DIR;
	if (envDir) {
...
// e.g., OPENABCODE_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://openabcode.com/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.OPENABCODE_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.openabcode/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.openabcode/agent/) */
