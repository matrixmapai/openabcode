import { ProcessTerminal, setKeybindings, TUI } from "@openabcode/tui";
...
const OFFICIAL_PACKAGE_NAME = "@openabcode/coding-agent";
const OFFICIAL_APP_NAME = "openabcode";
const OFFICIAL_CONFIG_DIR_NAME = ".openabcode";
 ...
 * - experimental features are enabled (OPENABCODE_EXPERIMENTAL=1)
