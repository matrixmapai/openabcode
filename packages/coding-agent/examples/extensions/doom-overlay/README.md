...
Play DOOM as an overlay in openabcode. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
openabcode --extension ./examples/extensions/doom-overlay
```
