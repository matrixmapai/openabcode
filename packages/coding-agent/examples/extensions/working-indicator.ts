 ...
 * working indicator shown while openabcode is streaming a response.
 *
 * Usage:
 *   openabcode --extension examples/extensions/working-indicator.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@openabcode/coding-agent";
