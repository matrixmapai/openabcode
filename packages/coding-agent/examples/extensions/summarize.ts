import { complete, getModel } from "@openabcode/ai/compat";
import type { ExtensionAPI, ExtensionCommandContext } from "@openabcode/coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@openabcode/coding-agent";
import { Container, Markdown, matchesKey, Text } from "@openabcode/tui";
