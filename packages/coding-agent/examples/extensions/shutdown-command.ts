 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit openabcode cleanly.
 */
...
export default function (pi: ExtensionAPI) {
	// Register a /quit command that cleanly exits openabcode
	pi.registerCommand("quit", {
		description: "Exit openabcode cleanly",
	...
	pi.registerTool({
		...
		description: "Complete a task and exit openabcode",
	...
	pi.registerTool({
		...
		description: "Deploy the application and exit openabcode",
		parameters: Type.Object({
