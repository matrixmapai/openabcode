...
import { complete, type Message } from "@openabcode/ai/compat";
import type { ExtensionAPI, SessionEntry } from "@openabcode/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@openabcode/coding-agent";
