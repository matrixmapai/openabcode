 ...
 *
 * Usage: openabcode --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@openabcode/coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@openabcode/tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@openabcode/tui";
