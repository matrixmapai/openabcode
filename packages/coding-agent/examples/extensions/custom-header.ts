 ...
 * (logo + keybinding hints) with a custom component showing the openabcode mascot.
 */

import type { ExtensionAPI, Theme } from "@openabcode/coding-agent";
import { VERSION } from "@openabcode/coding-agent";

// --- OPENABCODE MASCOT ---
// Based on pi_mascot.ts - the openabcode agent character
