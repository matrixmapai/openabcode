 ...
 *
 *   mkdir -p ~/.openabcode/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.openabcode/agent/extensions/
 *
 * Or:
 *
 *   openabcode -e packages/coding-agent/examples/extensions/project-trust.ts
 *
 * Try it in a project containing .openabcode, AGENTS.md/CLAUDE.md, or .agents/skills.
 */

import type { ExtensionAPI, ProjectTrustEventResult } from "@openabcode/coding-agent";
