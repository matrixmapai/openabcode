...
import type { AssistantMessage, Model } from "@openabcode/ai";
...
vi.mock("@openabcode/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@openabcode/ai/compat")>();
	return {
		...actual,
