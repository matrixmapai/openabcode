...
import { Agent } from "@openabcode/agent-core";
import { getModel, type OAuthCredentials, type OAuthProvider } from "@openabcode/ai/compat";
import { getOAuthApiKey } from "@openabcode/ai/oauth";
...
// ============================================================================
// OAuth API key resolution from ~/.openabcode/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".openabcode", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.openabcode/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.openabcode/agent/auth.json
 */
...
/** Path to the real openabcode agent config directory */
export const OPENABCODE_AGENT_DIR = join(homedir(), ".openabcode", "agent");

/**
 * Get an AuthStorage instance backed by ~/.openabcode/agent/auth.json
