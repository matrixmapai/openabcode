...
/**
 * Regression test for https://github.com/matrixmapai/openabcode/issues/2791
 *
...
process.env.OPENABCODE_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync(process.execPath, [scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, OPENABCODE_CODING_AGENT_DIR: agentDir },
