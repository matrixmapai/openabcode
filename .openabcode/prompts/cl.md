...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/matrixmapai/openabcode/issues/123))`
- External: `Added bar ([#456](https://github.com/matrixmapai/openabcode/pull/456) by [@user](https://github.com/user))`
